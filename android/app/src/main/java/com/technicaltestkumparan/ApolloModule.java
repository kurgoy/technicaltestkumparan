...
import com.technicaltestkumparan.type.PatchSize;
...
public class ApolloModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void query(Integer pageSize, String cursor, String patchSize, Callback successCallback, Callback failureCallback) {
    apolloClient.query(new LaunchListQuery(Input.fromNullable(pageSize), Input.optional(cursor), Input.optional(PatchSize.valueOf(patchSize)))).enqueue(new ApolloCall.Callback<Data>() {
      @Override
